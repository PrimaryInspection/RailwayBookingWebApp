...
import controller.command.localization.SetLocaleCommand;
import controller.command.user.BookTicketsCommand;
import controller.command.user.MainPageCommand;
import controller.command.user.MakeTicketsCommand;
import controller.command.user.SelectCityDateTimeCommand;
...
public class ControllerHelper {
    ...
    private ControllerHelper() {
        ...
        commands.put(bundle.getString("command.admin.npage"), new ToNPageCommand());

        commands.put(bundle.getString("command.locale"), new SetLocaleCommand());
